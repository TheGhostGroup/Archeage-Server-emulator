...
namespace AAEmu.Game.Models.Game.World.Transforms
{
    public class PositionAndRotation
    {
        ...
        public (short,short,short) ToRollPitchYawShorts()
        {
            ...
            var roll = (short)(vec3.X / (Math.PI * 2) / ToShortDivider);
            var pitch = (short)(vec3.Y / (Math.PI * 2) / ToShortDivider);
            var yaw = (short)(vec3.Z / (Math.PI * 2) / ToShortDivider);
        ...
        {
            var vec3 = ToRollPitchYaw();
            var roll = (sbyte)(vec3.X / (Math.PI * 2) / ToSByteDivider);
            var pitch = (sbyte)(vec3.Y / (Math.PI * 2) / ToSByteDivider);
            var yaw = (sbyte)(vec3.Z / (Math.PI * 2) / ToSByteDivider);
            return (roll, pitch, yaw);
        }
        ...
        {
            var vec3 = ToRollPitchYaw();
            var roll =  MathUtil.ConvertRadianToDirection(vec3.X - (MathF.PI / 2));
            var pitch = MathUtil.ConvertRadianToDirection(vec3.Y - (MathF.PI / 2));
            var yaw =   MathUtil.ConvertRadianToDirection(vec3.Z - (MathF.PI / 2));
            /*
