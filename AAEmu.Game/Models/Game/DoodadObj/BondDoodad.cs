...
namespace AAEmu.Game.Models.Game.DoodadObj
{
    public class BondDoodad : PacketMarshaler
    {
        ...
        public BondDoodad(AttachPoint attachPoint, int space, int spot, uint animActionId)
        {
        ...
        public BondDoodad(Doodad owner, AttachPoint attachPoint, int space, int spot, uint animActionId)
        {
            SetOwner(owner);
            _attachPoint = attachPoint;
            _space = space;
