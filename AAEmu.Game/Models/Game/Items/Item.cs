...
namespace AAEmu.Game.Models.Game.Items
{
    ...
    public class Item : PacketMarshaler, IComparable<Item>
    {
        ...
        public virtual byte DetailType => 0; // TODO 1.0 max type: 8, at 1.2 max type 9 (size: 9 bytes), at 3.0.3.0 max type 10 (size: 10 bytes)
        ...
        public override PacketStream Write(PacketStream stream)
        {
            ...
            stream.Write(DateTime.UtcNow); // chargeUseSkillTime for 3.0.3.0
            return stream;
        }
