...
namespace AAEmu.Game.Models.Game.Team
{
    public class PingPosition : PacketMarshaler
    {
        ...
        public override void Read(PacketStream stream)
        {
            ...
            Flag = stream.ReadByte();     // flag, added in 3.0.3.0
            ...
            Pisc1 = stream.ReadPisc(4); // added in 3.0.3.0
            Pisc2 = stream.ReadPisc(2); // added in 3.0.3.0

            LineCount = stream.ReadByte();   // lineCount, added in 3.0.3.0
